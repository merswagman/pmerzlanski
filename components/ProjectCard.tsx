...
export default function ProjectCard({ project }: { project: Project }) {
  ...
  return (
    <Link href={`/projects/${project.id}`} className="block group">
      <div className="rounded-xl bg-white p-4 shadow-sm ring-1 ring-gray-200 hover:shadow-md hover:ring-indigo-200 transition-all">
        <div className="flex items-start justify-between gap-2 mb-2">
          <h3 className="font-medium text-gray-900 group-hover:text-indigo-700 transition-colors line-clamp-2 leading-snug">
            {project.title}
          </h3>
